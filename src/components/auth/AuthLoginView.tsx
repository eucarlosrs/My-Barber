  ...
  const demoAccounts = [
    {
      ...
      title: 'Master Admin (Dono da Plataforma)',
      name: 'Carlos (Master Admin)',
      ...
      targetView: 'Painel Master Admin'
    },
    {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-950 text-neutral-100 flex flex-col justify-between selection:bg-orange-500 selection:text-neutral-950">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[650px] h-[350px] bg-orange-600/15 blur-[120px] rounded-full"></div>
        <div className="absolute -bottom-40 right-10 w-[450px] h-[300px] bg-amber-600/10 blur-[100px] rounded-full"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-4xl mx-auto w-full">
          ...
          <div className="lg:col-span-7 bg-neutral-900/90 border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
            ...
            <form onSubmit={handleGoogleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-neutral-950 border border-neutral-800 focus:border-emerald-500 rounded-2xl px-4 py-3 text-sm text-neutral-100 placeholder-neutral-600 focus:outline-none transition-colors font-mono"
                  />
                </div>
              ...
              {/* Google Account Card */}
              <div className="p-4 bg-neutral-950 border border-neutral-800/90 rounded-2xl">
                ...
                {!useCustomGoogleAccount ? (
                  <div className="flex items-center gap-3 bg-neutral-900/80 p-2.5 rounded-xl border border-neutral-800">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-orange-500 to-amber-500 text-neutral-950 font-black flex items-center justify-center text-xs shadow">
                      {googleName.charAt(0)}
                    </div>
                    <div className="text-left min-w-0 flex-1">
                      <div className="text-xs font-bold text-neutral-200 truncate">{googleName}</div>
                      <div className="text-[11px] text-neutral-400 truncate">{googleEmail}</div>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-2 pt-1">
                    <input
                      ...
                      className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-3 py-2 text-xs text-neutral-100 focus:outline-none focus:border-orange-500"
                    />
                    <input
                      type="email"
                      value={googleEmail}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-3 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-neutral-950 font-black py-3.5 px-4 rounded-2xl text-sm flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 transition-all active:scale-[0.98] cursor-pointer disabled:opacity-50"
              >
                {isLoading ? (
            ...
            <div className="mt-5 pt-4 border-t border-neutral-800/70 flex items-center justify-between text-xs">
              <span className="text-neutral-400">Quer apenas ver os serviços?</span>
              <button
                type="button"
                onClick={() => setViewMode('CLIENT_APP')}
                className="font-bold text-orange-400 hover:text-orange-300 flex items-center gap-1 transition-colors cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 space-y-3.5">
            ...
            <div className="bg-neutral-900/60 border border-neutral-800/80 rounded-3xl p-5 backdrop-blur-md">
              ...
              <div className="space-y-2">
                {demoAccounts.map((acc, index) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-2xl bg-neutral-950/80 hover:bg-neutral-950 border border-neutral-800 hover:border-orange-500/50 transition-all group flex items-center justify-between gap-2.5 cursor-pointer shadow-sm"
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-neutral-200 group-hover:text-orange-400 transition-colors truncate">
                          {acc.name}
                        </span>
                      </div>
                    </div>

                    <div className="shrink-0 flex items-center gap-1 text-[10px] font-bold text-orange-400 bg-orange-500/10 px-2 py-1 rounded-lg border border-orange-500/20">
                      <span>Entrar</span>
            ...
            <div className="bg-neutral-900/40 border border-neutral-800/60 rounded-2xl overflow-hidden">
              <button
                ...
                className="w-full p-3.5 flex items-center justify-between text-xs text-neutral-300 hover:text-white transition-colors cursor-pointer"
              >
                <div className="flex items-center gap-2">
              ...
              {showAdminSection && (
                <form onSubmit={handleAdminSubmit} className="p-4 pt-0 space-y-3 border-t border-neutral-800/60 mt-1">
                  <div>
                    <label className="block text-[11px] text-neutral-400 mb-1">E-mail administrativo</label>
                    <input
                      type="email"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-neutral-800 hover:bg-neutral-700 text-neutral-200 font-bold py-2 rounded-xl text-xs transition-colors cursor-pointer"
                  >
      ...
      {/* Footer */}
      <footer className="relative z-10 w-full py-4 border-t border-neutral-900 text-center text-xs text-neutral-400">
