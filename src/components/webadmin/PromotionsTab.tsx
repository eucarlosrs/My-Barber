                  ...
                  <div className="space-y-2">
                    ...
                    {promo.code && (
                      <div className="bg-neutral-950 p-2.5 rounded-xl border border-neutral-800 flex items-center justify-between">
                        <div>
                          <span className="text-[9px] uppercase font-bold text-neutral-500 block">Código do Cupom:</span>
                          <span className="text-xs font-black font-mono text-orange-400">{promo.code}</span>
                        </div>
                        <button
                          onClick={() => handleCopyCode(promo.code!)}
                          className="px-2.5 py-1 bg-neutral-800 hover:bg-neutral-700 text-neutral-300 rounded-lg text-[10px] font-bold flex items-center gap-1 transition-colors"
                        >
